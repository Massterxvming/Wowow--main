...
import 'package:wowowwish/pages/login/logic.dart';
...
class SetPasswordPage extends StatefulWidget {
  ...
  @override
  State<SetPasswordPage> createState() => _ResetPasswordPageState();
}

class _ResetPasswordPageState extends State<SetPasswordPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const ToolBar(title: '设置密码'),
      body: Padding(
